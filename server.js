...
app.get('/api/books/:id', function (req, res) {
  ...
  db.Book.findOne({id: req.params.id}, function(err,book){
...
app.post('/api/books', function (req, res) {
  ...
  console.log('books create', req.body.title);
  db.Book.create({ 
...
app.delete('/api/books/:id', function (req, res) {
  ...
  db.Book.findOneAndRemove({_id: req.params.id}, function(err,deleted){
    if(err) return res.send(err);
    res.json(deleted);
  })
  // var bookId = req.params.id;
